...
jQuery(function($) {
	...
	initPhotoSwipeFromDOM( '.gallery-items', args );
});


/*  -------------------------------------------------------------
 EXTENDED FUNCTIONS BELOW THIS LINE
 ------------------------------------------------------------- */
var initPhotoSwipeFromDOM = function( gallerySelector, defaultOptions ) {
	...
	var openPhotoSwipe = function(index, galleryElement, disableAnimation, fromURL) {
		...
		if ( typeof defaultOptions === 'object' ) {
			for ( var n in defaultOptions ) {
				if ( !defaultOptions.hasOwnProperty(n) ) continue;
