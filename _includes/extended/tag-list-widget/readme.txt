...
**Only use version 1.2 or higher with WordPress 4.2 and later releases.** WordPress 4.2 changed how taxonomy information is stored in the database, which directly impacts this plugin's _includes/exclude term functionality.
...
= 1.2 =
* Update for WordPress 4.2 to handle term splitting in the plugin's _includes/exclude functionality. Details at https://make.wordpress.org/core/2015/02/16/taxonomy-term-splitting-in-4-2-a-developer-guide/.
...
* Fixed persistent bugs in the _includes/exclude functionality.
