...
class c2c_AdminPostNavigation {
	...
	public static function admin_enqueue_scripts_and_styles() {
		...
		wp_register_style( 'admin-post-navigation-admin', 
		get_template_directory_uri() . '/_includes/extended/admin-post-navigation/assets/admin-post-navigation.css');
		wp_enqueue_style( 'admin-post-navigation-admin' );

		wp_register_script( 'admin-post-navigation-admin', 
		get_template_directory_uri() . '/_includes/extended/admin-post-navigation/assets/admin-post-navigation.js');
		// Localize script.
