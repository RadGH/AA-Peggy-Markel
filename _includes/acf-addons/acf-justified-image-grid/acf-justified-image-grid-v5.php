	...
	function __construct() {
		...
		*/
		...
		$this->settings = array(
			...
			'justified_css' 	=> get_template_directory_uri() . '/_includes/acf-addons/acf-justified-image-grid/css/justifiedGallery.css',
			'justified_js'		=> get_template_directory_uri() . '/_includes/acf-addons/acf-justified-image-grid/js/jquery.justifiedGallery.js',
			'swipebox_css' 		=> get_template_directory_uri() . '/_includes/acf-addons/acf-justified-image-grid/js/swipebox/css/swipebox.css',
			'swipebox_js'		=> get_template_directory_uri() . '/_includes/acf-addons/acf-justified-image-grid/js/swipebox/js/jquery.swipebox.min.js',
			'custom_js'			=> get_template_directory_uri() . '/_includes/acf-addons/acf-justified-image-grid/js/acf-jig-custom.js'
		);
...
<div <?php acf_esc_attr_e($atts); ?>>
	...
	*/	
	...
	function input_admin_enqueue_scripts() {		
		...
		// register & include JS
		wp_register_script( 'acf-input-justified_image_grid', "{$dir}/_includes/acf-addons/acf-justified-image-grid/js/input.js" );
