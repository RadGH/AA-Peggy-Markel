		...
		class acf_medium_editor_field extends acf_field {
			...
			*/
			...
			function input_admin_enqueue_scripts() {
				...
				wp_register_script('medium-editor', $url.'/_includes/acf-addons/acf-medium-editor-field/assets/vendor/medium-editor/js/medium-editor'.$min.'.js', array(), $version);
				wp_enqueue_script('medium-editor');
				
				wp_register_script('medium-button', $url.'/_includes/acf-addons/acf-medium-editor-field/assets/vendor/medium-button/src/medium-button.min.js', array('medium-editor'), $version);
				wp_enqueue_script('medium-button');
				
				wp_register_style('medium-editor', $url.'/_includes/acf-addons/acf-medium-editor-field/assets/vendor/medium-editor/css/medium-editor'.$min.'.css', array(), $version);
				...
				wp_register_style('medium-editor-theme', $url.'/_includes/acf-addons/acf-medium-editor-field/assets/vendor/medium-editor/css/themes/'.$theme.$min.'.css', array('medium-editor'), $version);
				wp_enqueue_style('medium-editor-theme');
				
				wp_register_style('medium-editor-input', $url.'/_includes/acf-addons/acf-medium-editor-field/assets/css/input.css', array('medium-editor-theme'), $version);
				wp_enqueue_style('medium-editor-input');
				
				wp_register_script('acf-input-medium-editor', $url.'/_includes/acf-addons/acf-medium-editor-field/assets/js/input.js', array('acf-input'), $version);
