...
<?php
    ...
    */
    ...
    function input_admin_enqueue_scripts() {
        ...
        wp_register_script('acf-input-image_crop', "{$dir}/_includes/acf-addons/acf-image-crop-add-on/js/input.js", array('acf-input', 'imgareaselect'));

        wp_register_style('acf-input-image_crop', "{$dir}/_includes/acf-addons/acf-image-crop-add-on/css/input.css", array('acf-input'));
...
// added END
    ...
    */
    ...
    function field_group_admin_enqueue_scripts() {
        ...
        wp_register_script('acf-input-image-crop-options', "{$dir}/_includes/acf-addons/acf-image-crop-add-on/js/options.js", array('jquery'));
        wp_enqueue_script( 'acf-input-image-crop-options');

        wp_register_style('acf-input-image-crop-options', "{$dir}/_includes/acf-addons/acf-image-crop-add-on/css/options.css");
