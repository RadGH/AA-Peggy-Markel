...
// @jgraup:         Adding multiple methods for changing color and opacity with the keyboard.
    ...
    */
    ...
    function input_admin_head() {
        ...
        // register & include JS
        wp_register_script( 'acf-js-background', "{$dir}/_includes/acf-addons/acf-background/js/field_background.js" );
        wp_enqueue_script('acf-js-background');

        // register & include CSS
        wp_register_style( 'acf-css-background', "{$dir}/_includes/acf-addons/acf-background/css/field_background.css" ); 
    ...
    function input_admin_enqueue_scripts() {
        ...
        // register & include JS
        wp_register_script( 'acf-js-rgba_minicolors', "{$dir}/_includes/acf-addons/acf-background/js/jquery.minicolors.min.js" );
